...
const HomeStack = () => {
  ...
  const toggleHeart = async (selectedSize) => {
    ...
    if (!isHearted) {
      try {
        ...
        const updatedProductDetails = { name: productName, price: productPrice, selectedSize };
        await AsyncStorage.setItem('productDetails', JSON.stringify(updatedProductDetails));
      } catch (error) {
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name='Your Cart' component={AddToCart} options={{ headerShown: false }} />
      <Stack.Screen name='Your Address Book' component={Address} options={{ headerShown: false }} />
  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={({ route }) => ({
          headerShown: false,
          tabBarIcon: ({ color, size }) => (<SimpleLineIcons name="home" size={24} color={color} />),
      ...
      <Tab.Screen name='Search' component={Search} options={{ headerShown: false, tabBarIcon: ({ color, size }) => (<AntDesign name="search1" size={24} color={color} />), }} />
      <Tab.Screen
        name="Heart"
        component={Heart}
        options={({ route }) => ({
      ...
      />
      <Tab.Screen name='Profile' component={Profile} options={{ headerShown: false, tabBarIcon: ({ color, size }) => (<AntDesign name="user" size={24} color={color} />), }} />
    </Tab.Navigator>
  );
};
